...
def route_metadata(
    *,
    ...
    lawn_game_items = [{"name": game["name"], "url": "/lawn-games"} for game in lawn_games]
    ...
    routes: dict[str, dict[str, Any]] = {
        ...
        "/lawn-games": {
            ...
            "description": "Rent lawn games in Bridgewater, the South Shore, and across Nova Scotia. Available games include Cornhole, Giant Connect 4, Giant Jenga, Ladder Toss, Ring Toss, Badminton, Tug of War, Bocce Ball, Spikeball, Giant Tic Tac Toe, Croquet, and Birch Wood Washer Toss.",
            "image": LAWN_IMAGE,
            "schema": [
                item_list_schema("Nova Kingdom Rentals lawn games", "/lawn-games", lawn_game_items),
                breadcrumb_schema("/lawn-games", "Lawn Game Rentals"),
            ],
        },
        "/about": {
...
def main() -> None:
    ...
    routes = route_metadata(site_info=site_info, products=products, packages=packages, faqs=faqs, seo_pages=seo_pages, lawn_games=lawn_games)
